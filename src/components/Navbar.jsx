...
<li>
            <Link
              ...
              className={activeLink === "home" ? "text-green " : ""}
            >
              Home
            </Link>
          </li>
          <li>
            <Link
              ...
              className={activeLink === "menu" ? "text-green" : ""}
            >
              Menu
            </Link>
          </li>
          <li>  
            <a
              ...
              onClick={() => handleLinkClick("services")} // Set active link on click
              className={activeLink === "services" ? "text-green" : ""}
            >
              Services
            </a>
          </li>
          <li>
            <a
              ...
              onClick={() => handleLinkClick("offers")} // Set active link on click
              className={activeLink === "offers" ? "text-green" : ""}
            >
              Offers
            </a>
          </li>
